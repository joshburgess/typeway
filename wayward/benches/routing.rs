...
wayward_path!(type P5 = "a" / u32 / "b" / u32 / "c");
wayward_path!(type P6 = "x" / "y" / "z");
wayward_path!(type P7 = "api" / "v1" / "items" / u32);
wayward_path!(type P8 = "api" / "v1" / "items");
wayward_path!(type P9 = "api" / "v2" / "things" / u32);
wayward_path!(type P10 = "health");
