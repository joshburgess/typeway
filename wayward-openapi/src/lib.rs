//! `wayward-openapi` — OpenAPI 3.1 spec derivation from Wayward API types.
//!
...
pub use derive::{
    ApiToSpec, CollectOperations, EndpointDoc, EndpointToOperation, QueryParameters, ToSchema,
};
